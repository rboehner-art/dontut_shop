<?php
    ...
    if (($_SERVER["REQUEST_METHOD"] == "POST") && (!($formErr))){
        ...
        try {
            ...
            $sql = "INSERT INTO RB_nov22_Contacts (name, email, contactBack, comments) VALUES (:name, :email, :contactBack, :comment);";
...
<html lang="en">
	...
	<body>
				...
				<section id="contact" style="background-color:#FFF7AE;">
